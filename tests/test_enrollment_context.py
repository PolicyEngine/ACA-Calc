...
def test_state_based_marketplace_state_returns_unavailable_fallback():
    ...
    assert context.aptc_consumers is None
    assert "local enrollment context is disabled" in context.message
...
def test_unknown_county_in_state_based_marketplace_returns_fallback():

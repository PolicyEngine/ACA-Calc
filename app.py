            ...
            with st.spinner("Calculating..."):
                ...
                if ptc_2025 > 0 and ptc_2026 == 0:
                    if fpl_pct > 400:
                        ...
                        **Why?** Your income exceeds 400% FPL. The IRA removed this cliff, but it returns in 2026.
                        Even $1 over the limit means losing ALL credits.
                        """)
                    else:
                        st.warning(f"""
                        ...
                        **Why?** Higher contribution requirements in 2026 mean the benchmark plan 
                        now costs less than what you're expected to pay.
                        """)
